        ...
        <div class="container">
            ...
            <form action="SvModificarServicio" method="GET">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nombre" name="nombre" value="<%=serv.getNombre()%>" required />
                </div>
                <div class="form-group">
                    <label for="descripcion">Descripción</label>
                    <input type="text" class="form-control" id="descripcion" name="descripcion" placeholder="Ingrese descripción" value="<%=serv.getDescripcionBreve()%>" required />
                </div>
                <div class="form-group">
                    <label for="destino">Destino</label>
                    <input type="text" class="form-control" id="destino" name="destino" placeholder="Ingrese destino" value="<%=serv.getDestino()%>" required />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="costo" name="costo" placeholder="Ingrese costo" value="<%=serv.getCosto()%>" onkeypress="return isNumber(event)" required />
                </div>
                    <input type="hidden" name="cod" value="<%=serv.getCodigoServicio()%>" > 
