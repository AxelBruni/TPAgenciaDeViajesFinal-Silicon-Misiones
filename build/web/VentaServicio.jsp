    ...
    <main role="main" class="flex-shrink-0">
        <div class="container">
                    ...
                    <%SimpleDateFormat formatoFecha = new SimpleDateFormat("yyyy-MM-dd");
                     ...
                     <tr>
                         <% int cod = serv.getCodigoServicio();
                          ...
                          <td><%=costo%></td>
                          <td>
                            <input class="form-check-input" type="radio" value="<%=cod%>" id="checkbox1" name="servVenta">  
                          </td>
                     </tr>
                     <% } %>
                </tbody>
          ...
          <div class="row justify-content-center align-items-center">
              <br>
              <br>
              <%Cliente clienteVenta = (Cliente) misession.getAttribute("clienteVenta");
                int idClie = clienteVenta.getIdPersona();%>
                <input type="hidden" name="clie" value="<%=idClie%>">
