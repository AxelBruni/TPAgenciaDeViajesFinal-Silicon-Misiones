        ...
        <div class="container">
            ...
            <form action="SvEmpleado" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="dni" name="dni" placeholder="Ingrese dni" onkeypress="return isNumber(event)" required />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="celular" name="celular" placeholder="Ingrese celular" onkeypress="return isNumber(event)" required />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="sueldo" name="sueldo" placeholder="Ingrese sueldo" onkeypress="return isNumber(event)" required />
                </div>
                <div class="form-group">
                    <label for="usuario">Nombre de usuario</label>
                    <input type="text" class="form-control" id="usuario" name="usuario" placeholder="Ingrese nombre de usuario" required />
                </div>
                <div class="form-group">
                    <label for="Contraseña">Contraseña</label>
                    <input type="text" class="form-control" id="pass" name="pass" placeholder="Ingrese contraseña" required />
                </div>
