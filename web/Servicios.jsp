    ...
    <main role="main" class="flex-shrink-0">
        <div class="container">
                    ...
                    <%SimpleDateFormat formatoFecha = new SimpleDateFormat("yyyy-MM-dd");
                     ...
                     <tr>
                         <% int cod = serv.getCodigoServicio();
                          ...
                          <td><%=costo%></td>
                          <td>
                              <form name="modServicio" action="SvModificarServicio" method="POST" style=display:inline>
                                  <input type="hidden" name="cod" value="<%=cod%>">
                                  <button type="submit" class="btn btn-primary btn-sm" data-title="Modificar" style=display:inline>Modificar</button>
                              </form>     
                          </td>
                          <td>
                              <form name="borrarServicio" action="SvBorrarServicio" method="GET" style=display:inline>
                                  <input type="hidden" name="cod" value="<%=cod%>">
            ...
            <div class="row justify-content-center align-items-center">
                <a href="AltaServicio.jsp">
                    <button class="btn btn-primary btn-sm">Agregar Servicio</button>
                </a>
            </div>  
    </main>
